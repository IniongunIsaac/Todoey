//
//  CategoryCoreDataViewController.swift
//  Todoey
//
...
class CategoryCoreDataViewController: UITableViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        let destinationVC = segue.destination as! TodoCoreDataViewController
...
extension CategoryCoreDataViewController: UISearchBarDelegate{
